...
from {{ref("orders")}} as orders -- the ref function is referencing a seed file. 
--This is not best practice for files that are constantly changing but this is just for learning purposes.
